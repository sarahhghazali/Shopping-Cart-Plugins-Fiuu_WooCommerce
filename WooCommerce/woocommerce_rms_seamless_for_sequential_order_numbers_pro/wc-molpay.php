...
function wcmolpay_gateway_load() {
    ...
    class WC_Molpay_Gateway extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            $this->method_description = __( 'Proceed payment via Razer Merchant Services Seamless Integration Plugin for<br><font color="red"><b>This is for Sequential Order Numbers Pro</b></font>', 'woocommerce' );
        ...
        /**
         * This part is notify function for Razer Merchant Services
         * 
         * @global mixed $woocommerce
         */
